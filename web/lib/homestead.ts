...
export const MENAGERIE_SPOTS: Record<string, PetSpot> = {
  'parrot_red':        { x:  7, y: 71, w: 20 },
  'parrot_blue':       { x: 18, y: 65, w: 15 },
  'parrot_green':      { x: 27, y: 60, w: 10 },
  'parrot_charcoal':   { x: 74, y: 61, w: 10, flip: true },
  'parrot_sand':       { x: 80, y: 64, w:  7 },
  'parrot_gold':       { x: 93, y: 71, w: 20, flip: true },
  'monkey_brown':      { x: 47, y: 78, w: 14 },
  'monkey_golden':     { x: 53, y: 92, w: 19, flip: true },
  'seal_brown':        { x: 28, y: 81, w: 15 },
  'seal_gray':         { x: 37, y: 76, w: 13 },
  'seal_gold':         { x: 38, y: 94, w: 18, flip: true },
  'lizard_green':      { x: 36, y: 58, w:  7 },
  'lizard_indigo':     { x: 55, y: 58, w:  7, flip: true },
  'lizard_white':      { x: 48, y: 58, w:  7 },
  'raccoon_beige':     { x: 63, y: 78, w: 16 },
  'raccoon_black':     { x: 74, y: 88, w: 19, flip: true },
  'crab_orange':       { x: 22, y: 90, w: 12 },
  'crab_blue':         { x: 55, y: 72, w: 10 },
  'crab_gold':         { x: 65, y: 93, w: 13 },
  'plesiosaur_baby':   { x: 84, y: 84, w: 24 },
}
