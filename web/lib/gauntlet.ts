...
export const GAUNTLET_BOONS: GauntletBoon[] = [
  ...
  { id: 'wildfire', name: 'Wildfire', flavor: 'You set the sea alight and let it do the work the guns started.', rarity: 'rare', tiers: [
    ...
    { desc: '20% burn, 4 turns, ticks 20% (max), Reignite + Backdraft', detail: 'Burn chance 20%, burns last 4 turns and each tick deals 20% of the hit (the burn ceiling), with Reignite. BACKDRAFT: when a burn finally goes out it detonates for a burst of damage on top of the last tick.', effect: { kind: 'fireAffinity', burnChance: 0.20, burnTurnsBonus: 2, burnTickMult: 2.0, reignite: true, backdraft: true } },
  ] },
