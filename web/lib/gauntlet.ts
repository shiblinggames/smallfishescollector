...
export const GAUNTLET_BOONS: GauntletBoon[] = [
  ...
  { id: 'leviathans_hunger', image: '/gauntlet/boons/leviathans_hunger.png', name: "Leviathan's Hunger", flavor: 'Every wound you open, the deep drinks — and feeds it back to your hull.', rarity: 'legendary', tiers: [
    ...
    { desc: 'Heal 15% of the damage you deal, up to 30% of your hull a hit', detail: 'Whenever you damage an enemy, your ship heals for 15% of that damage. One hit can return at most 30% of your maximum HP, which is always twice your lifesteal. Other lifesteal, like Davy’s Blood Cannon, adds to your percentage and lifts that cap with it.', effect: { kind: 'lifestealPct', pct: 0.15 } },
  ] },
