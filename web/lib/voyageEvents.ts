      ...
      case 'danger': {
        ...
        if (safe) {
          ...
          if (loseCrew) {
            ...
            const narrative = template.narrative.replace('{name}', victim.name)
...
const DISCOVERY_SUCCESS = [
  { title: 'Sunken Wreck',     narrative: "The hull was still sealed. Bars of silver gleamed beneath the salt water. The crew worked fast before the ship finally gave way." },
  { title: "Smuggler's Cache", narrative: "A hidden cove, a false rock, and a stash tucked beneath it. Whoever left this isn't coming back for it." },
  ...
  { title: 'Message Buoy',     narrative: "A merchant's coded buoy marking a salvage claim. The crew got there before the merchant did." },
]
...
const DISCOVERY_FAIL = [
  ...
  { title: 'Empty Cove',      narrative: "The cove looked promising until it didn't. Just gulls and old rope." },
...
const ENCOUNTER_WIN = [
  { title: 'Pirate Ambush',   narrative: "The corsairs cut across the bow looking for easy prey. The crew answered with a volley. The pirates turned and ran, leaving their spoils behind." },
  ...
  { title: 'Rival Crew',      narrative: "Another crew, desperate and armed. They tested the crew's resolve — and found it." },
  { title: 'Toll Gate',       narrative: "An armed convoy tried to levy a toll. The crew's show of strength was enough. They sailed through without paying." },
  { title: 'Merchant Deal',   narrative: "A stranded merchant ship needed an escort through contested waters. The crew obliged, and the merchant paid well." },
]

const ENCOUNTER_LOSS = [
  { title: 'Pirate Ambush',   narrative: "The corsairs hit fast and hard. The crew drove them off eventually, but the fight cost time and they arrived empty-handed." },
  ...
  { title: 'Naval Patrol',    narrative: "A patrol cutter demanded inspection and found nothing illegal — but the delay burned hours." },
