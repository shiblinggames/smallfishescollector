...
export const RAID_MAP: RaidNode[] = [
  ...
  //    slot). Raid 8 and everything after it stays adminOnly until it ships. ─────
  {
    ...
    scene: [
      ...
      { ...GUIDE.doby, text: 'The last fathom. I was born in water like this, small fry. Black, and cold, and patient. It is the one part of the sea I have ever been afraid of.' },
