...
export const RAID_MAP: RaidNode[] = [
  ...
  // The scene[] + Logbook fragment land with the cutscene itself.
  {
    ...
    scene: [
      ...
      // He talks with his back to you. No name, no face on the plate: the scene
      // must not spell out who this is one beat before it lands the reveal.
      { speaker: 'The Man in the Boat', text: "Took you long enough. I'd about run out of water to wait on." },
      { text: 'You know that voice. You cannot place it, standing here in the wrong ocean with your hand going for a cutlass, but you know it the way you know a door in your own house in the dark.', pause: 700 },
      { speaker: 'The Man in the Boat', text: "Go on then. Say something. You've come an awful long way to stand there." },
      { text: 'He turns around.', pause: 1000, fx: 'flash', insert: { kind: 'finn-unmasked' }, closeup: true },
      { ...GUIDE.finn, text: "Surprised? Heh." },
      { text: 'Finn.', pause: 900, closeup: true },
      { ...GUIDE.finn, text: "Finn. Finn-dicate. Say it out loud once and tell me you never heard it. Go on. Everyone hears it eventually, and never once before it's too late to matter." },
