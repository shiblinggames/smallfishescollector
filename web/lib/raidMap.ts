...
export const RAID_MAP: RaidNode[] = [
  {
    ...
    bridge: "To the reef, and Pete's little fish.",
    detail: {
      description:
  ...
  },
  {
    ...
    bridge: "Thin them out and Pete sails out himself.",
    requiresNode: 'intro',
  ...
  },
  {
    ...
    bridge: "Pete sinks broke. So where's the plunder?",
  ...
  },
  {
    ...
    bridge: "Coin talks. A fence learns your name.",
    requiresNode: 'pete',
