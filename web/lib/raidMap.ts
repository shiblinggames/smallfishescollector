...
export const RAID_MAP: RaidNode[] = [
  ...
  // The scene[] + Logbook fragment land with the cutscene itself.
  {
    ...
    scene: [
      ...
      { ...GUIDE.doby, text: "The whole Finndicate. A hundred years of it. That was your *tackle box*." },
      { ...GUIDE.finn, text: "Forty years of my own life in it, and the deep still would not let me near them." },
      ...
      { ...GUIDE.doby, text: "He's ABSORBING them. Four hundred years those slept, and he is taking every last thing they had." },
      ...
      { ...GUIDE.finn, text: "Forty years. *Finally.* The power I have been longing for." },
      ...
      { ...GUIDE.doby, text: "Four hundred years out here and I have never felt anything like that. There is nothing left in this ocean that can close this." },
      { ...GUIDE.finn, text: "Six keys, and the door is open, and I am already through it. You did that. Remember that you did that." },
      { ...GUIDE.finn, text: "You'll come after me. You have never once done the sensible thing, and I built ten years on it." },
