...
export const RAID_MAP: RaidNode[] = [
  ...
  // The scene[] + Logbook fragment land with the cutscene itself.
  {
    ...
    scene: [
      ...
      { text: 'The loudmouth off your own dock. The one who laughs at your boat every morning and tells you where the real fish are.', pause: 700 },
      { text: 'Standing at the bottom of the Finndicate, on the last water on their map, waiting on you.', pause: 800 },
      { ...GUIDE.kat, text: "No. No. That is it? That is the whole Sunken Hand? Captain, you *complain* about him. Every week. About his *hat*." },
      { ...GUIDE.doby, text: "Four chapters. Four chapters we bled up that ladder, and it ends at a dockside loudmouth with a hand line." },
      { ...GUIDE.mako, text: "Captain, tell them he is not the one. Tell them we have the wrong water." },
      { ...GUIDE.finn, text: "Finn. *Finn-dicate.* Nobody ever hears it until it is far too late to help them." },
      { text: 'The whole crew goes quiet at once.', pause: 900, closeup: true },
      { ...GUIDE.mira, text: "...That is the F off the crooked ledger. The one I swore to you was a dead partner." },
      { ...GUIDE.finn, text: "A dead partner. I like that. I might keep it." },
      { text: 'Pete. Krust. The Cache. The don. Every name you took down this whole campaign was his.', pause: 700 },
      { ...GUIDE.laz, text: "The don died saying it was never the family, it was the feeding. He was quoting you." },
      { ...GUIDE.finn, text: "He was. He never once understood what he was saying." },
      { ...GUIDE.finn, text: "The cargo was never cargo. Forty years I hauled it out here and dropped it in the dark, trying to buy that water open." },
      { ...GUIDE.doby, text: "You were fishing for the ancients. All of it, so you could pull the old ones up." },
      { ...GUIDE.finn, text: "I was. And it never worked. Not once." },
      { text: 'And the grin goes.', pause: 900, closeup: true },
      { text: 'Not slowly. All at once, like a lamp going out.', pause: 700 },
      { ...GUIDE.finn, text: "The deep would not open for me. So I stopped trying, and went looking for someone it *would* open for." },
      { ...GUIDE.finn, text: "You were never my rival, captain. You were a tool I found on a beach and spent ten years sharpening." },
      { text: 'Every goad about deeper water. Every laugh at your boat. A hand at your back the whole way down.', pause: 800, closeup: true },
      { ...GUIDE.finn, text: "You thought a rod bought you that water. You bought it by gutting my house. Every door you kicked down, I left unlocked for you." },
      { ...GUIDE.finn, text: "You cleared out my own ranks and called it a campaign. Then you went down where I cannot go and brought me all six." },
      { ...GUIDE.kat, text: "Captain. Whatever he wants, he is not getting it." },
      { ...GUIDE.finn, text: "You are carrying them right now. Did you never wonder why they never rotted?" },
      ...
      { ...GUIDE.doby, text: "He is ABSORBING them. Four hundred years those slept, and he is taking every last thing they had." },
      { text: 'What comes down on the water afterward is only the shape. Grey and light and wrong, like driftwood.', pause: 700 },
      { text: 'And Finn stands up, and the boat does not rock, because whatever is standing up in it does not weigh what it used to.', pause: 800 },
      ...
      { text: 'Forty years of dockside angler was a costume. This is what was wearing it.', pause: 1000, closeup: true },
      { ...GUIDE.mira, text: "I have hunted the worst captains in this ocean. Not one of them was ever a *what*." },
      { ...GUIDE.doby, text: "Four hundred years out here and I have never seen that shape. There is nobody left who closes this." },
      { ...GUIDE.finn, text: "Six keys, and the door is open, and I am already through it. You did that. Remember that you did that." },
      { ...GUIDE.finn, text: "You will come after me. You have never once done the sensible thing, and I built ten years on it." },
      { ...GUIDE.finn, text: "One last ride, then. You and me and the deep. You will be on time. You always are." },
