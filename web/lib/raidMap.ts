...
export const RAID_MAP: RaidNode[] = [
  ...
  // The scene[] + Logbook fragment land with the cutscene itself.
  {
    ...
    scene: [
      ...
      { text: 'There is a small boat on it. A man sits in the boat with a line in the water, and he does not turn around when you come alongside.', pause: 700 },
      { speaker: 'The Man in the Boat', text: "Took you long enough. I'd about run out of water to wait on." },
      ...
      { text: 'Finn. The rival off your dock. Standing in the last place on the Finndicate’s map.', pause: 800, closeup: true },
      { ...GUIDE.finn, text: "Finn. *Finn-dicate.* Nobody ever hears it until it is far too late to help them." },
      { ...GUIDE.mira, text: "Captain, that is the F off the crooked ledger. The one I told you was a dead partner." },
      ...
      { text: 'Then, one at a time, in the order you caught them, they go out. Not eaten. Emptied.', pause: 900, fx: 'shake' },
      { ...GUIDE.doby, text: "Four hundred years those slept and you are DRINKING them." },
      { text: 'The husks come down on the water like driftwood, grey and light and wrong.', pause: 700 },
      { text: 'And Finn stands up, and the boat does not rock, because he does not weigh what a man weighs any more.', pause: 800 },
      ...
      { text: 'Forty years of fisherman was a costume. This is what was wearing it.', pause: 1000, closeup: true },
      { ...GUIDE.mira, text: "I have hunted the worst people in this ocean. Not one of them was ever a *what*." },
