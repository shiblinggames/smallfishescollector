...
export const RAID_MAP: RaidNode[] = [
  ...
  },
  {
    ...
    image: '/bilge_eel.png',
    scene: [
      { text: "You've made it to the Bilge Strait. Lucky you." },
      { text: "You're not alone though. The strait belongs to the Bilge Eels... now that name makes sense." },
      { speaker: 'A Bilge Eel', portrait: '/bilge_eel.png', text: "Far enough, captain. You're crossing into our waters now." },
      { speaker: 'A Bilge Eel', portrait: '/bilge_eel.png', text: "We don't report to anyone but ourselves. And the only master we serve is doubloons." },
      // The crew get the measure of them before the narration explains it.
      // Mako sailed in one node ago; this is his first word since.
      { ...GUIDE.mako, text: "These greedy rats... I mean eels." },
      { ...GUIDE.doby, text: "They've only ever cared about coin." },
      { text: "It's hard to stay neutral in this territory, but looks like the Bilge Eels control a water that has made them richer. And they're ones to take advantage of that situation." },
      { speaker: 'A Bilge Eel', portrait: '/bilge_eel.png', text: "We see a lot of freight sailing these waters. And they all gotta pay us." },
      { speaker: 'A Bilge Eel', portrait: '/bilge_eel.png', text: "1,000 doubloons gets you a smooth crossing. And we'll forget we ever saw ya." },
      { text: "Doesn't seem like there's another way around." },
      { text: "Looks like you gotta pay up or earn enough to get through." },
    ],
    sceneAccent: '#7dd3fc',
    detail: {
      description:
        "The letter's heading runs out past the Bilge Strait, and the strait belongs to the Bilge Eels. Two banks and a gap barely wide enough for a couple of hulls, which is the whole reason they can charge for it.\n\nThey report to nobody and serve only doubloons. Not the Finndicate, not you. They sit on the one crossing that points where C.K.'s cargo went and they take a cut of everything that passes, because there is no way around. Pay them 1,000 ⟡ and the way opens onto C.K.'s trail. Keep your purse shut and you go no further.",
      drops: [
      ...
      summary: "The Bilge Eels own the only crossing on C.K.'s heading and serve nothing but doubloons. A thousand of them bought the passage, and C.K.'s trail runs on past the strait.",
    },
  },
  {
    id: 'quartermaster',
  ...
  },
  {
    ...
    type: 'story',
    label: 'Between Watches',
    flavor: "The Tollmaster is under and his books are open. Before the next heading, the crew reads where all that coin was actually going.",
    bridge: "The rest never lasts. Spet's own papers name where every sealed crate ended up: the Coffers, out in the northeastern seas.",
    requiresNode: 'gullet_raid',
    image: '/raidlog.png',
    scene: [
      { text: "You've brought down the Tollmaster. And with it, the Finndicate's finances will have a gaping hole." },
      { ...GUIDE.dole, text: "Spet's accounting only confirms what we know. They've been on a spending spree." },
      { ...GUIDE.doby, text: "That's why they've been pillaging and plundering. They're hungry for doubloons to fuel their purchases." },
      { ...GUIDE.mako, text: "Spet counted the coin, but the doubloons still went past him." },
      { ...GUIDE.dole, text: "I remember seeing this on one of the Cartographer's maps too. Past the Gullet... everything gets dumped into something known as the *Coffers*." },
      { ...GUIDE.mako, text: "Coffers? Guess we'll need to bring them some coff drops." },
      // The pause is the joke. Without it his "..." is a line that failed.
      { ...GUIDE.dole, text: "...", pause: 700 },
      { ...GUIDE.kat, text: "Anyways... Dole is right. Spet's own accounting documents show that anything signed and sealed by him gets sent over there." },
      { ...GUIDE.dole, text: "We've got a heading. It's gonna be out in the northeastern seas." },
      { ...GUIDE.doby, text: "Rest up captain, we've got a long way to sail." },
      { text: "The next task looms large. But you know it's better to rest and be ready than to dive in. Right?" },
    ],
    detail: {
      description:
        "The Gullet is mud and the Tollmaster is under it, which leaves a gaping hole in the Finndicate's finances and their accounting lying wide open.\n\nSpet's books confirm what the crew already suspected: the outfit has been on a spending spree, and all that pillaging was only ever fuel for it. The coin never stopped with Spet either. Anything he signed and sealed went on somewhere else, to a place the Cartographer's maps named as well. The Coffers, out in the northeastern seas. Rest up. It is a long way to sail.",
      ctaLabel: 'Rest a While →',
      summary: "With the Tollmaster under, his books named where every sealed crate went. The Finndicate has been spending everything it steals, and all of it ends up in the Coffers, out in the northeastern seas.",
    },
  },
  {
  ...
  // Ch I) is revealed a Finndicate front, and names Don Finleone. The Ch IV hook.
  {
    ...
    flavor: "Spet weighed everything the Gullet swallowed and kept none of it. His manifests all point the same way, to a harbor where the Finndicate's coin gets traded and divided.",
    bridge: "The Coffers is where the Finndicate's money is tracked and divided, and you are closer to its inner workings than anyone has been. The only ways in are a blockade or a bribe.",
    requiresNode: 'chapter_2_class',
    image: '/raidlog.png',
    scene: [
      { text: "The Coffers. Seems like a place for the Finndicate elite. Even the air smells rich." },
      { ...GUIDE.dole, text: "It's a whole exchange out here. Everything must get traded at the harbor." },
      { ...GUIDE.kat, text: "So all the funds get tracked and then divvied up here?" },
      { ...GUIDE.doby, text: "Seems like it. I feel like we're on a fast track to the real inner workings of the Finndicate now." },
      { ...GUIDE.kat, text: "Looks like our reputation hasn't caught up to us yet... but before long they'll know of what we did." },
      { ...GUIDE.laz, text: "Oh I know what you've all done." },
      { ...GUIDE.doby, text: "Who...!" },
      { ...GUIDE.laz, text: "At ease, captains. Laz. I'm here looking to infiltrate Finndicate operations. They took down my family business." },
      { ...GUIDE.laz, text: "I've worked peacefully for years as a retired captain. They started pillaging our businesses for no reason. I managed to track down one of their merchant ships and have been following ever since." },
      { ...GUIDE.laz, text: "I came here once before to ask them why. They wrote me into the books as a debt, closed the account, and left me in this water. I'm the one entry they got wrong." },
      { ...GUIDE.laz, text: "Not to sound creepy. But they've mentioned a motley crew going around taking down pieces of their operation one at a time. Their description... was accurate." },
      { ...GUIDE.dole, text: "...And we just trust this?" },
      { ...GUIDE.kat, text: "We did for you." },
      { ...GUIDE.dole, text: "...", pause: 700 },
      { ...GUIDE.laz, text: "Trust me or not, having eavesdropped on their merchant ships, I know my way around the harbor a bit now. I'm sure I'd be a valuable resource for your team." },
      { text: "Laz joins the party. He is now recruitable in your crew rolls." },
    ],
    detail: {
      description:
        "Every manifest off Spet's deck points the same way: past the Gullet to a harbor the honest charts leave blank. The Coffers is the Finndicate's own exchange, where everything the outfit takes is traded, tracked and divided, and the air smells of how well that has been going.\n\nYour reputation has not reached the place yet, which will not last. Laz found you on the way in: a retired captain the Finndicate pillaged out of his family business, who came here once to ask why and was written into their books as a debt, closed out, and left in the water. He has been following their merchant ships ever since, and he knows his way around the harbor. The only ways through its door are a blockade or a bribe.",
      drops: [
        { emoji: '📜', label: "Captain's Logbook, Fragment VIII", sublabel: "\"Everything gets traded at the harbor. The funds get tracked here, and divided here.\"", rarity: 'uncommon' },
      ],
      dropsNote: 'An exchange with a name at last, and two ways through its door.',
      ctaLabel: 'Read the Manifests →',
      summary: "Spet's manifests led you to the Coffers, the exchange where the Finndicate's coin is tracked and divided. Laz found you there: they ruined his family business, then closed his account and left him in this water. The way in is a blockade or a bribe.",
    },
  },
  {
  ...
  },
  {
    ...
    detail: {
      ...
      dropsNote: 'Deepen the class you already sail or branch into a fresh one. It stays with you for good, barring the single refit the end of the campaign buys you.',
      ctaLabel: 'Pick a class',
    },
  },
