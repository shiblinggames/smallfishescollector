...
export const THE_TOLLMASTER: BossRaidConfig = {
  ...
  preFightDialogue: [
    { speaker: 'narrator', text: "You sailed into the Gullet and brought down ranks of low barracuda hulls to arrive at the Tollmaster himself." },
    { speaker: 'boss', text: "You've come a long way down my channel, captain. I see that you've become a bit too familiar with the finances of the Finndicate. That's my sea to sail. Not yours." },
    { speaker: 'crew', ...CREW_SPEAKER.doby, text: "Tollmaster Spet... I presume. Why do all the operations go through you? What's the purpose of the Gullet?" },
    { speaker: 'boss', text: "I handle the Finndicate's accounting. Sounds boring, but it gives me a ton of power. And control. You've messed with our bottom line by sinking some of our best. And that's not something that we just write off." },
    { speaker: 'crew', ...CREW_SPEAKER.kat, text: "The Finndicate doesn't just do normal business anymore, it seems. What are you guys really up to?" },
    { speaker: 'crew', ...CREW_SPEAKER.mako, text: "You've got captains feeding you stolen resources. A cartographer supplying you charts to... who knows where. None of this makes sense... at least in any good way." },
    { speaker: 'boss', text: "Who determines what's good? I just make sure everything balances out." },
    { speaker: 'crew', ...CREW_SPEAKER.dole, text: "Then surely you know that there's some illegal activity going on within the Finndicate!" },
    { speaker: 'boss', text: "No one audits me. I say what's illegal or not. And the only thing I know that is illegal is your trespassing into my territory.", pause: 500 },
    { speaker: 'crew', ...CREW_SPEAKER.mako, text: "I've never met an accountant that could fight." },
    { speaker: 'boss', text: "You're a fool then. Our battles are done with numbers.", pause: 600 },
    { speaker: 'crew', ...CREW_SPEAKER.kat, text: "Let's show Spet who's putting up the real numbers." },
  ],
}
