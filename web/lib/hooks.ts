...
export const HOOKS: HookDef[] = [
  ...
  { tier: 4, name: 'Silver Hook',    cost: 12000,  description: 'Polished silver. Catches the light — and the fish.',         color: '#d4d4d8', imageUrl: '/hook_silver.png',    glow: true, glowType: 'chrome' },
  { tier: 5, name: 'Gold Hook',      cost: 22000,  description: "Polished gold. Fish can't resist the shine.",               color: '#f0c040', imageUrl: '/hook_gold.png',      glow: true, glowType: 'gilded' },
  { tier: 6, name: 'Enchanted Hook', cost: 40000,  description: 'Glows faintly. Something stirs in the deep.',              color: '#a78bfa', imageUrl: '/hook_enchanted.png', glow: true, glowType: 'arcane' },
  { tier: 7, name: 'Abyssal Hook',   cost: 70000,  description: 'Drawn from the dark. The catch window is remarkably wide.', color: '#38bdf8', imageUrl: '/hook_abyssal.png',   glow: true, glowType: 'cursed' },
  { tier: 8, name: 'Legendary Hook', cost: 150000, description: 'Said to have been lost at sea — and returned.',             color: '#ff6b35', imageUrl: '/hook_legendary.png', glow: true, glowType: 'mythic' },
]
