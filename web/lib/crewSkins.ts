...
export const CREW_SKINS: CrewSkin[] = [
  ...
  { id: 'orca_royalty',     slug: 'orca', name: 'Royalty',      filename: 'Orca_royalty.png',     gemCost: 1250, blurb: 'Born to rule the pod, crowned by the tide.', color: '#b18cf0' },
  // ── Tiger Shark (Ty) — Epic ──
  ...
  { id: 'tiger_shark_crimson',  slug: 'tiger_shark', name: 'Crimson',  filename: 'Tiger_Shark_bloodcrimson.png', gemCost: 1250, blurb: 'Striped in fresh blood, and hungry for more.', color: '#dc2626' },
  ...
  { id: 'goblin_shark_eldritch',   slug: 'goblin_shark', name: 'Eldritch',    filename: 'Goblin_Shark_eldrich.png',    gemCost: 1250, blurb: 'Something older than the deep wears its face.', color: '#9d7bd8' },
  ...
  { id: 'blue_whale_opulent',    slug: 'blue_whale', name: 'Opulent',    filename: 'Blue_Whale_opulent.png',    gemCost: 1250, blurb: 'Draped in gold, vast beyond counting.', color: '#f0c040' },
  ...
  { id: 'humpback_whale_glacial',       slug: 'humpback_whale', name: 'Glacial',        filename: 'Humpback_glacial.png',        gemCost: 1250, blurb: 'Carved from the ice of the farthest north.', color: '#7dd3fc' },
