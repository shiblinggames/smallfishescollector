...
export const CREW_SKINS: CrewSkin[] = [
  ...
  // ── Blobfish (Bloo) — Rare ──
  { id: 'blobfish_bighero',   slug: 'blobfish', name: 'Big Hero',   filename: 'Blobfish_bighero.png',   gemCost: 750, blurb: 'Soft of body, iron of heart. The reef\'s unlikely champion.', color: '#c0384a' },
  { id: 'blobfish_partyblob', slug: 'blobfish', name: 'Party Blob', filename: 'Blobfish_partyblob.png', gemCost: 750, blurb: 'First to the grog, last to leave the deck.',                color: '#ec4899' },
  // ── Orca (Orc) — Epic ──
  ...
  { id: 'great_white_shark_ghostrelic', slug: 'great_white_shark', name: 'Ghost Relic', filename: 'Great_White_ghostrelic.png', gemCost: 1000, blurb: 'Bleached bone and old ghosts.', color: '#a9c0cc' },
  { id: 'great_white_shark_iceborn',    slug: 'great_white_shark', name: 'Iceborn',     filename: 'Great_White_iceborn.png',    gemCost: 1000, blurb: 'Forged in the coldest deep.',  color: '#7dd3fc' },
]
