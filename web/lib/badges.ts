...
export const BADGES: Badge[] = [
  ...
  // three new-data hooks: goldens (shiny_catches), Finn's jobs (finn_quests_done), fish
  ...
  { id: 'one_upped',      name: 'The Hand on the Rod', description: "Finish the first chapter of Finn's jobs",          imageUrl: '/badges/one_upped.png',      difficulty: 'seasoned'    },
  ...
  { id: 'finns_rival',    name: 'The Long Sail',       description: "Finish three chapters of Finn's jobs",             imageUrl: '/badges/finns_rival.png',    difficulty: 'master'      },
  ...
  { id: 'the_better_angler', name: 'The Better Angler', description: 'Finish every job Finn sets you',                  imageUrl: '/badges/the_better_angler.png', difficulty: 'grandmaster' },
  ...
  { id: 'market_maker',    name: 'Market Maker',       description: 'Turn a profit on 100 contracts',                   imageUrl: '/badges/market_maker.png',    difficulty: 'master'      },
