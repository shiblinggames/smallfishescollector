// The Throne (Challenge) — the scaled court. Ultimates / aim-bar attacks /
// the don's three phases all carry through the challenge scaling. ADMIN-ONLY
// until the Last Fathom launches (drop this guard + the map adminOnly flags
// together, per the Ch3 playbook).

import { redirect } from 'next/navigation'
import RaidGame from '../../RaidGame'
import { getRaidPlayerStats } from '../../actions'
import { THE_THRONE_CHALLENGE } from '@/lib/raidChallenge'
import { getCurrentUser, getCurrentProfile } from '@/lib/userData'

export default async function ThroneChallengeRaidPage() {
