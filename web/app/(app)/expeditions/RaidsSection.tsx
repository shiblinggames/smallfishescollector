...
import { ChapterUnlockOverlay, UltimateUnlockOverlay } from './UnlockOverlays'
...
// Moved out so the sea can open a boss card without pulling this whole map in
// behind it. See the note at the top of that file.
import {
  BossFightModal, DropDetailModal, formatRaidMs, makeLiveChance, bossNameOf,
} from './BossFightModal'
...
/* ── Chapter-unlock + Ultimate-weapon overlays ──────────────────
   Both moved to ./UnlockOverlays so the sea can fire the same two moments.
