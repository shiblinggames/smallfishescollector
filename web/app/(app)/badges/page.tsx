  ...
  const groups: JourneyGroup[] = [
    {
      ...
      accent: '#4ade80',
      goals: [
        badgeGoal('prestige_i', 'Prestige I', 'Reach Prestige in any fishing zone', totalStars > 0 ? 1 : 0, 1, '/sea', { binary: true }),
        badgeGoal('trophy_catch', 'Trophy Catch', 'Land a Trophy-tier fish', has('trophy_catch') ? 1 : 0, 1, '/sea', { binary: true }),
        badgeGoal('wet_behind_ears', 'Wet Behind the Ears', 'Reach Fishing Level 25', fishLevel, 25, '/sea'),
        badgeGoal('old_hand', 'Old Hand', 'Reach Fishing Level 50', fishLevel, 50, '/sea'),
        badgeGoal('master_angler', 'Master Angler', 'Reach Fishing Level 100', fishLevel, 100, '/sea'),
        badgeGoal('unbroken', 'Unbroken', 'Land 10 perfect catches in a row', streakBest, 10, '/sea'),
        badgeGoal('relentless', 'Relentless', 'Land 15 perfect catches in a row', streakBest, 15, '/sea'),
        badgeGoal('untouchable', 'Untouchable', 'Land 20 perfect catches in a row', streakBest, 20, '/sea'),
        badgeGoal('in_the_flow', 'In the Flow', 'Land 30 perfect catches in a row', streakBest, 30, '/sea'),
        badgeGoal('sure_shot', 'Sure Shot', 'Land 250 perfect catches all-time', totalPerfects, 250, '/sea'),
        badgeGoal('dead_eye', 'Dead-Eye', 'Land 1,000 perfect catches all-time', totalPerfects, 1000, '/sea'),
        badgeGoal('crack_shot', 'Crack Shot', 'Land 2,500 perfect catches all-time', totalPerfects, 2500, '/sea'),
        badgeGoal('eagle_eyed', 'Eagle-Eyed', 'Land 5,000 perfect catches all-time', totalPerfects, 5000, '/sea'),
        ...
        badgeGoal('zone_legend', 'Zone Legend', 'Reach Prestige in all 4 zones', prestigedZones, 4, '/sea'),
        badgeGoal('high_water_mark', 'High Water Mark', 'Reach Max Prestige in any fishing zone', topZonePrestige, 5, '/sea'),
        badgeGoal('prestige_stars', 'Prestige Stars', 'Earn all 20 prestige stars (5 per zone)', totalStars, 20, '/sea'),
        ...
        badgeGoal('fully_rigged', 'Fully Rigged', 'Forge all 3 effects into the Completionist Rod', rodEffectsCount, 3, '/sea'),
        badgeGoal('reforged', 'Reforged', 'Pay to re-forge the rod into a fresh 3-effect loadout', has('reforged') ? 1 : 0, 1, '/sea', { binary: true }),
        ...
        badgeGoal('two_for_the_pot', 'Two for the Pot', 'Reel in a double catch', doubleCatches, 1, '/sea', { binary: true }),
        badgeGoal('two_fisted', 'Two-Fisted', 'Land 100 double catches', doubleCatches, 100, '/sea'),
        ...
        badgeGoal('the_fourth_task', 'The Fourth Task', 'Clear 25 Master daily challenges', masterCleared, 25, '/sea'),
        badgeGoal('reel_lucky', 'Reel Lucky', 'Hit a fishing jackpot', jackpots, 1, '/sea', { binary: true }),
        badgeGoal('friend_at_sea', 'A Friend at Sea', 'Earn your first fishing pet', petsOwned, 1, '/sea', { binary: true }),
        badgeGoal('full_stringer', 'Full Stringer', 'Keep 3 fishing pets at once', petsOwned, 3, '/sea'),
        badgeGoal('menagerie', 'The Menagerie', 'Keep 5 fishing pets at once', petsOwned, 5, '/sea'),
        badgeGoal('first_haul', 'First Haul', 'Collect your first trawl', trawlsCollected, 1, '/sea', { binary: true }),
        badgeGoal('steady_nets', 'Steady Nets', 'Collect 25 trawls', trawlsCollected, 25, '/sea'),
        badgeGoal('deep_trawler', 'Deep Trawler', 'Collect 100 trawls', trawlsCollected, 100, '/sea'),
        badgeGoal('net_positive', 'Net Positive', 'Collect 500 trawls', trawlsCollected, 500, '/sea'),
      ],
    },
    {
      ...
      accent: '#60a5fa',
      goals: [
        badgeGoal('half_the_sea', 'Half the Sea', 'Catch 50 fish species', collectionCount, 50, '/sea'),
        badgeGoal('hundred_fins', 'A Hundred Fins', 'Catch 100 fish species', collectionCount, 100, '/sea'),
        badgeGoal('ancient_ones', 'Ancient Ones', 'Catch all 6 Ancient Deep giants', ancientsCaught, 6, '/sea'),
        // ── THE LONG VIGIL ── the six giants mastered, post-finale.
        badgeGoal('back_to_the_dark', 'Back to the Dark', 'Release an Ancient back into the deep', vigilEverReleased ? 1 : 0, 1, '/sea', { binary: true }),
        badgeGoal('twice_landed', 'Twice Landed', 'Raise an Ancient to Vigil Rank II', vigilTopRank, 2, '/sea'),
        badgeGoal('six_abreast', 'Six Abreast', 'Every Ancient at Vigil Rank III or better', vigilAtRankIII, 6, '/sea'),
        badgeGoal('struck_in_gold', 'Struck in Gold', 'Take an Ancient to Vigil Rank V', vigilTopRank, VIGIL_MAX_RANK, '/sea'),
        badgeGoal('deep_remembers', 'The Deep Remembers', 'Reach 20 total Vigil', vigilPoints, 20, '/sea'),
        badgeGoal('the_long_vigil', 'The Long Vigil', 'Master all six Ancients at Rank V', vigilPoints, VIGIL_MAX_TOTAL, '/sea'),
        badgeGoal('a_real_keeper', 'A Real Keeper', 'Land 10 Trophy-size catches', trophySizeCatches, 10, '/sea'),
        badgeGoal('trophy_hunter', 'Trophy Hunter', 'Land 25 Trophy-size catches', trophySizeCatches, 25, '/sea'),
        badgeGoal('full_collection', 'Full Collection', `Catch every fish species (${prestigedAll ? speciesTotal : collected}/${speciesTotal})`, prestigedAll ? speciesTotal : collected, speciesTotal, '/sea'),
      ],
    },
    {
      title: 'Crew',
    ...
    },
    {
      ...
      accent: '#5ec8e8',
      goals: [
        badgeGoal('massive_booty', 'Massive Booty', 'Land a Massive Booty on a voyage', bootyHauls, 1, '/sea', { binary: true }),
        badgeGoal('maiden_voyage', 'Maiden Voyage', 'Complete your first voyage', voyagesDone, 1, '/sea', { binary: true }),
        badgeGoal('old_sea_dog', 'Old Sea Dog', 'Complete 50 voyages', voyagesDone, 50, '/sea'),
        badgeGoal('fleet_admiral', 'Fleet Admiral', 'Complete 100 voyages', voyagesDone, 100, '/sea'),
      ],
    },
    {
      title: 'Raids',
    ...
    },
    {
      ...
      goals: [
        ...
        badgeGoal('one_last_ride', 'One Last Ride', 'Clear The Sunken Hand', raidIds.has('the_sunken_hand') ? 1 : 0, 1, '/sea', { binary: true }),
        badgeGoal('cut_off_at_the_wrist', 'Cut Off at the Wrist', 'Clear The Sunken Hand on Challenge', raidIds.has('the_sunken_hand_challenge') ? 1 : 0, 1, '/sea', { binary: true }),
        badgeGoal('the_long_quiet', 'The Long Quiet', 'See the Sunken Hand through to its end', clearedNodes.includes('the_long_quiet') ? 1 : 0, 1, '/sea', { binary: true }),
        badgeGoal('ancient_tackle', 'Ancient Tackle', 'Earn your first Ancient-rarity item', spoilsOwned >= 1 ? 1 : 0, 1, '/sea', { binary: true }),
        badgeGoal('salvors_claim', "Salvor's Claim", 'Open a berth from the wreck', berthsOpen, 1, '/sea'),
        badgeGoal('both_hands', 'Both Hands', 'Open both berths from the wreck', berthsOpen, 2, '/sea'),
        badgeGoal('something_old', 'Something Old', 'Carry your first Primeval spoil', spoilsOwned, 1, '/sea'),
        badgeGoal('both_in_hand', 'Both in Hand', 'Own both Primeval spoils', spoilsOwned, 2, '/sea'),
        ...
        badgeGoal('market_maker', 'Market Maker', 'Turn a profit on 100 contracts', ex.won, 100, '/tavern/market'),

        // ── Bounties ──
        badgeGoal('first_bounty', 'Took the Job', 'Claim your first bounty', bountiesClaimed, 1, '/sea'),
        badgeGoal('full_board', 'Board Cleared', 'Claim every order posted in one day', bountyBoards, 1, '/sea'),
    ...
    },
    {
      ...
      accent: '#b8c4d0',
      goals: [
        badgeGoal('navigator', 'Wayfinder', 'Reach Navigation Level 50', navLevel, 50, '/sea'),
        badgeGoal('master_navigator', 'Master Navigator', 'Reach Navigation Level 100', navLevel, 100, '/sea'),
        ...
        badgeGoal('fresh_coat', 'Fresh Coat', 'Own a boat skin', boatSkinsOwned, 1, '/sea'),
        badgeGoal('full_drydock', 'Full Drydock', `Own every boat skin (${boatSkinsOwned}/${SHIP_SKINS.length})`, ownsAllBoatSkins ? SHIP_SKINS.length : boatSkinsOwned, SHIP_SKINS.length, '/sea'),
        badgeGoal('six_aboard', 'Six Aboard', 'Add the Sixth Berth to your ship', hasSixthBerth ? 1 : 0, 1, '/sea', { binary: true }),
        badgeGoal('expanded_armory', 'Expanded Armory', 'Bolt on the Expanded Armory mount', hasArmoryExpansion ? 1 : 0, 1, '/sea', { binary: true }),
        badgeGoal('weapon_of_legend', 'Weapon of Legend', 'Build your Man-o-War ultimate', hasUltimate ? 1 : 0, 1, '/sea', { binary: true }),
        badgeGoal('first_fusion', 'First Fusion', 'Forge your first item', hasForgedItem ? 1 : 0, 1, '/sea', { binary: true }),
        badgeGoal('grand_forgemaster', 'Grand Forgemaster', 'Learn every forge recipe', forgeRecipesLearned, FORGE_RECIPES.length, '/sea'),
      ],
    },
    {
      title: 'The Gauntlet',
      ...
      goals: [
        ...
        badgeGoal('abyssal_smith', 'The Abyssal Forge', 'Forge your first tier-3 Abyssal item', has('abyssal_smith') || abyssalOwned >= 1 ? 1 : 0, 1, '/sea', { binary: true }),
        badgeGoal('abyssal_master', 'Abyssal Master', 'Forge every Abyssal item', abyssalOwned, abyssalTotal, '/sea'),
        badgeGoal('ghost_armory', 'The Ghost Armory', "Own all three Don's Gauntlet items", ownsAllDonsItems ? 1 : 0, 1, '/sea', { binary: true }),
    ...
    },
    {
      ...
      goals: [
        ...
        badgeGoal('tide_champion', 'Tide Champion', 'Reach 450m in a single Tide Run', tideBest, 450, '/tavern/tide-run', { record: true }),
        badgeGoal('tide_master', 'Tide Master', 'Reach 600m in a single Tide Run', tideBest, 600, '/tavern/tide-run', { record: true }),
    ...
    },
    {
      ...
      accent: '#f5d98a',
      goals: [
        badgeGoal('complete_captain', 'The Complete Captain', 'Reach Navigation 100 and Fishing 100', (fishLevel >= 100 && navLevel >= 100) ? 1 : 0, 1, '/sea', { binary: true }),
        ...
        badgeGoal('baby_steps', 'Baby Steps', 'Hold 100,000 doubloons at once', doubloons, 100_000, '/sea'),
