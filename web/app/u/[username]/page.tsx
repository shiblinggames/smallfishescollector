...
export default async function ProfilePage({ params }: { params: Promise<{ username: string }> }) {
  ...
  const [{ data: { user } }, { data: profile }] = await Promise.all([
    ...
    admin.from('profiles')
      .select('id, username, showcase_variant_ids, is_premium, premium_expires_at, fishing_xp, expedition_xp, hook_tier, rod_tier, reel_tier, line_tier, ship_tier, ship_name, highest_perfect_streak, has_tide_turner, has_phantom_hook, equipped_ship_skin, raid_items, character_color, equipped_special, equipped_badges, equipped_boat, equipped_hat, avatar_bg_color, avatar_border_color')
