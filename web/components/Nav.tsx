...
export default function Nav({ packsAvailable, doubloons, gems }: { packsAvailable?: number; doubloons?: number; gems?: number }) {
  ...
  return (
    <>
      ...
      <nav className="hidden sm:flex border-b border-[rgba(255,255,255,0.15)] px-6 py-4 items-center justify-between" style={{ background: navBg(tint), position: 'fixed', top: 0, left: 0, right: 0, zIndex: 50 }}>
      ...
      <div className="sm:hidden border-b border-[rgba(255,255,255,0.15)] px-4 py-2 flex justify-between items-center" style={{ background: navBg(tint), position: 'fixed', top: 0, left: 0, right: 0, zIndex: 50 }} ref={menuRef}>
